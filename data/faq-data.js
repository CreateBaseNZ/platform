		...
		items: [
			{
				...
				a: (
					<>
						<p>
							Projects provide interactive and engaging STEAM experiences to students by walking them through the process of solving a real-world problem by applying STEAM concepts though our seven step creation process. This process has been crafted to provide value to any student as a framework to approach any engineering problem.
						</p>
						<p>
							Projects are delivered through a combination of teachers and our platform. To help teachers deliver Projects, each one comes with a detailed and customisable lesson plan.
						</p>
					</>
				)
			},
			{
				...
				a: (
					<>
						...
						<ul>
							<li><Link href="/intro-to-flow.pdf">Intro to Flow pdf</Link></li>
							<li><Link href="/explore/comparison-boost">Comparison boost</Link></li>
							<li><Link href="/explore/conditional-boost">Conditional boost</Link></li>
						</ul>
					</>
				),
			},
			...
			},
			{
				...
				a: (
					<>
						<p>Every student needs their own CreateBase account. In a future update, they will gain the ability to sign in using their Google account. To get your students on the platform, get them to visit <Link href="/">https://app.createbase.co.nz/</Link></p>
						<p>If your students don’t have CreateBase accounts, tell them to click sign up and fill out each field. If your students already have CreateBase accounts, they can click log in and enter their account details.</p>
		...
		items: [
			{
				...
				a: (
					<>
						<p>
							There are three different account types on the CreateBase platform;  Admin, Educator and Learner.
						</p>
						<p className="faq__indent"><span className="faq__bold">Admin</span>: Admin accounts have access to the entire platform. They are in charge of managing their organisations' users and billing information.</p>
						<p className="faq__indent"><span className="faq__bold">Educator</span>: These accounts are for all the teachers in your organisation. They have access to Projects, lesson plans and FAQs.</p>
						<p className="faq__indent"><span className="faq__bold">Learner</span>: Learner accounts are for students and have the most restricted access. These accounts can only access Projects to reduce distractions and keep students on task. Each student in your class needs to create their own learner account to access the platform.</p>
					</>
				),
			},
			{
			...
			},
			{
				...
				a: (
					<>
						<p>
							If you are the admin for your organisation, you can upgrade your account from the 18th of October through our website <Link href="https://createbase.co.nz/">https://createbase.co.nz/</Link> to gain access to the paid version of the platform.
						</p>
					</>
				),
			},
			...
			},
			{
				...
				a: (
					<>
						...
						<p>
							To join an organisation with an existing account, you can also go to the <Link href="/user">My Account</Link> page and click Create an Org. You will then be prompted to enter your school’s ID and name.
						</p>
		...
		items: [
			...
			},
			{
				...
				a: (
					<>
						<p>
							You can contact us for any reason via email at admin@createbase.co.nz or send us a message from our <Link href="https://createbase.co.nz/contact">website</Link>.
						</p>
						<p>
