    ...
    items: [
      {
        ...
        a: ["Each Project has its own set of 5-10 lesson plans. To access a Project’s lesson plans, click on the Project image at the bottom of the screen that corresponds to the Project you are interested in. The ‘Lesson Plan’ button will then appear. Clicking that button will open all the lesson plans for that Project in a new tab.", 
          "/faq-1.jpg",
      ...
      },
      {
        ...
        a: ["How you use lesson plans is entirely up to you. Each lesson plan comes structured in a straightforward way and contains everything you need to deliver the Project.", 
      ...
      },
      {
        ...
        a: ["Exactly as you would in a regular class environment!", 
      ...
      },
      {
        ...
        a: ["Each lesson plan includes a glossary at the start of each section. This contains explanations for all of the terminology that you need to know in order to be able to effectively deliver the Project and have class discussions.",
          "/faq-7.jpg",
      ...
      },
      {
        ...
        a: ["Lesson plans contain everything required to teach a Project.",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: ["All of our Projects use the Flow programming language purposefully built by CreateBase to enable students and teachers to learn about coding concepts and code solutions to our Projects.",
          "/faq-6.jpg",
      ...
      },
      {
        ...
        a: ["Learning journals are where students document what they’ve done throughout their Project journey.",
      ...
      },
      {
        ...
        a: ["Every student needs their own CreateBase account. In a future update, they will gain the ability to sign in using their Google account. To get your students on the platform, get them to visit https://app.createbase.co.nz/", 
    ...
    items: [
      {
        ...
        a: ["Currently, there is one account type. On the 12th of September, this will be increased to 3 account types;  Admin, Educator and Learner.",
      ...
      },
      {
        ...
        a: ["Admin accounts have access to the entire platform, including their organisation’s admin page.", 
      ...
      },
      {
        ...
        a: ["If you are the admin for your organisation, you can upgrade your account from the 18th of October through our website www.createbase.co.nz to gain access to the paid version of the platform."],
      },
      {
        q: "How do I upgrade my educator account to an admin account?",
        a: ["If you have an educator account and wish to become an admin for your organisation, please ask one of your organisation's current admins. Admin accounts have the ability to upgrade educator accounts in their organisation to admin accounts through the admin console."],
      },
      {
        q: "How do I join an existing organisation?",
        a: ["To join an organisation, go to the My Account page (http://app.createbase.co.nz/user) and click Join an Org. You will then be prompted to enter your organisation’s code, your school’s ID and your school’s name.  If you don’t know your organisation’s code, talk to one of your organisation's admin users. They can generate a code for you from their admin console.",
          "/faq-9.jpg"],
      },
      {
        q: "How do I register a new organisation?",
        a: ["At the end of your platform tutorial, there will be a prompt to create or join an organisation. You will need your school email address, school name, and school ID number to register a new organisation.", 
    ...
    items: [
      {
        ...
        a: ["Our platform is still under development. If you encounter any issues or things that you think could be optimised, then don’t hesitate to contact us, and we will fix your problem or potentially add your feature/change request to our development pipeline.",
      ...
      },
      {
        ...
        a: ["You can contact us for any reason via email at: admin@createbase.co.nz",
          "We will respond to any questions, comments or enquiries within one working day."],
      },
    ],
  },
];
