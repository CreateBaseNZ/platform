...
const DEFAULT_SECTION = {
	...
	tasks: [
		...
		{ id: "default-1", type: "link", title: "Your Flow Coding journey starts here", color: "#209CE2", imgUrl: "/task.png" },
	],
};
...
const NOT_GROUP_SECTION = {
	...
	tasks: [
		{ id: "not-group-0", type: "link", title: "Register your school", subtitle: "For admins and teachers", color: "#FF862F", imgUrl: "/task.png" },
		{ id: "not-group-1", type: "link", title: "Join your school group", subtitle: "For students", color: "#25D8B7", imgUrl: "/task.png" },
	],
	hasOr: true,
	orId: "not-group",
};
...
const GROUP_SECTION = {
	...
	tasks: [
		{ id: "group-0", type: "link", title: "Invite people to your group", color: "#FDB554", imgUrl: "/task.png" },
		{ id: "group-1", type: "text", title: "A quick guide to lesson plans", color: "#3C7EFF", imgUrl: "/task.png" },
		{ id: "group-2", type: "link", title: "Check out the Support tab", color: "#18DB66", imgUrl: "/task.png" },
		{ id: "group-3", type: "link", title: "Tour of class features", subtitle: "Classes (1/3)", color: "#FF427B", imgUrl: "/task.png" },
		{ id: "group-4", type: "link", title: "Create a class", subtitle: "Classes (2/3)", color: "#FF427B", imgUrl: "/task.png" },
		{ id: "group-5", type: "link", title: "Add members to your class", subtitle: "Classes (3/3)", color: "#FF427B", imgUrl: "/task.png" },
	],
};
	...
	return (
		<div className={`${classes.onboarding} roundScrollbar`}>
			...
			<div className={classes.view}>
				...
				<OnboardingSection section={GROUP_SECTION} statuses={statuses} setStatuses={setStatuses} checkHandler={checkHandler} />
			</div>
		</div>
	);
};
