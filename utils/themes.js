...
const themes = {
	"Light Themes": ["Atom One Light", "Ayu Light", "GitHub Light", "VS Light", "Light Owl", "Quiet Light", "Solarized Light", "Winter is Coming Light"],
	"Dark Themes": [
		"Atom One Dark",
		"Ayu Dark",
		"Ayu Mirage",
	...
	"Funky Themes": ["Gloom", "High Contrast", "Red", "Shades of Purple", "Solarized Dark", "Tomorrow Night Blue"],
};
