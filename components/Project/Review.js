      ...
      <div className={classes.cardContainer}>
        <div className={`${classes.cardWrapper} ${classes.survey}`}>
          ...
          <div className={classes.card}>
            ...
            Let us know how you found this project so we can make future
            projects even better
          </div>
          <a
            href="https://forms.gle/x9dXkBKe2JoewnHH8"
            target="_blank"
            title="CreateBase workshop survey"
          >
            Complete our survey
          </a>
        </div>
        <div className={`${classes.cardWrapper} ${classes.message}`}>
          ...
          <div className={classes.card}>
            ...
            Found a bug? Have some feedback? Just want to chat? We would love to
            hear from you
          </div>
          <a
