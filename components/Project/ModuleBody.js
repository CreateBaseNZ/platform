		...
		return (
			<div className={classes.empty}>
				...
				<div className={classes.emptyImg}>
					<Img src="https://raw.githubusercontent.com/CreateBaseNZ/public/main/project-pages/empty-modules.svg" layout="fill" objectFit="contain" label="Illustration by Storyset" />
				</div>
