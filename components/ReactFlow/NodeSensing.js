...
const NodeSensing = ({ data = { values: {}, connections: [] }, isConnectable, label, id = "float__out" }) => {
	return (
  ...
  /> */}
			<h4>{label}</h4>
			<CustomHandle type="source" position="right" id={id} isConnectable={isConnectable} connections={data.connections} />
		</div>
	);
};
...
export const NodeDistanceMini = () => {
	return (
		<NodeMini className={`${classes.sensing} ${classes.nodeDistance}`} nodeType="distance" node={<NodeDistance />}>
			{/* <h4>Distance from</h4>
...
export const NodeHeightOfMini = () => {
	return (
		<NodeMini className={`${classes.sensing} ${classes.nodeHeightOf}`} nodeType="heightOf" node={<NodeHeightOf />}>
			{/* <h4>Height of</h4>
      <div className={classes.blankInput}></div> */}
...
export const NodeWidthOfMini = () => {
	return (
		<NodeMini className={`${classes.sensing} ${classes.nodeWidthOf}`} nodeType="widthOf" node={<NodeWidthOf />}>
			{/* <h4>Width of</h4>
      <div className={classes.blankInput}></div> */}
...
export const NodeSpeedOfMini = () => {
	return (
		<NodeMini className={`${classes.sensing} ${classes.nodeSpeedOf}`} nodeType="speedOf" node={<NodeSpeedOf />}>
			{/* <h4>Speed of</h4>
      <div className={classes.blankInput}></div> */}
...
export const NodeElevationOfMini = () => {
	return (
		<NodeMini className={`${classes.sensing} ${classes.nodeElevationOf}`} nodeType="elevationOf" node={<NodeElevationOf />}>
			{/* <h4>Elevation of</h4>
      <div className={classes.blankInput}></div> */}
