...
const levels = { comparison: 3, if: 3, while: 3 };
	...
	return (
		<div className={`${classes.levelModal} ${classes[currMode]}`}>
			<div className={classes.menuContainer}>
				<div className={`${classes.menuWrapper} ${currMode !== selection.mode ? classes.disabled : ""}`}>
				...
				<div className={classes.menuWrapper}>
					<h3 className={`${classes.card} ${classes.titleCard}`}>Other Boosts</h3>
					{modes.map((m, i) => (
						<button
							key={i}
